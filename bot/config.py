...
BOT_DESCRIPTION = (
    "המהנדס הדיגיטלי | מערכת תרגול ופתרון בסטטיקה\n\n"
    "כלי לסטודנטים בסטטיקה שמכין אותך למבחן ויעזור לך לעבור את המבחן בהצלחה!\n\n"
    "מה הבוט יודע לעשות?\n\n"
    "שליחת תמונה של תרגיל לקבלת פתרון מלא או הדרכה מפורטת שלב אחרי שלב.\n\n"
    "יצירה של תרגילים וקבלה של פתרונות שמותאמים אישית לחומר.\n\n"
    "גישה מהירה למאגר נוסחאות ותרשימי עזר הנדסיים.\n\n"
    "בדיקת חישובי ראקציות ומהלכי כוחות פנימיים (M, V, N).\n\n"
    "לחצו על Start למטה כדי להתחיל 👇"
)

BOT_SHORT_DESCRIPTION = (
    "בוט ללימוד ותרגול סטטיקה: פתרון תרגילים מתמונה, מדריכי שלב-אחר-שלב ונוסחאות."
)
...
VISION_THINKING_BUDGET = _env_int("VISION_THINKING_BUDGET", 1024)
...
BOT_UI_VERSION = os.getenv("BOT_UI_VERSION", "2026-09-09-menu-refresh").strip()
