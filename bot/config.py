...
BOT_DESCRIPTION = (
    "─── מדריך ומחשבון סטטיקה ───\n\n"
    "היי, שמח שהגעת לכאן.\n"
    "בניתי את הבוט כדי להכין אותך מ-0 למעבר מוצלח של המבחן בסטטיקה.\n\n"
    "יכולות המערכת:\n"
    "• לימוד הבסיס — הסברים ותרגולים שלב אחר שלב\n"
    "• שליפת נוסחאות ממוקדות לפי נושא\n"
    "• תרגול ברמת מבחן ומדריך פתרון מלא\n"
    "• שליחת תמונה של תרגיל וקבלת פתרון ומדריך\n"
    "• דיווח תקלה ישירות אליי\n\n"
    "גישה חופשית ל-24 שעות להתרשמות מלאה.\n"
    "חבילה חודשית ב-39 ש\"ח (15% הנחה לכל חודש נוסף).\n\n"
    "לחץ על Start כדי לפתוח את התפריט הראשי."
)
